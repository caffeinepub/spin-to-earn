...
export class Backend implements backendInterface {
    ...
    async getRupeesFromPoints(arg0: bigint): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getRupeesFromPoints(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async jackpot(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.jackpot(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async luckyWinner(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.luckyWinner(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async scratchCard(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.scratchCard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async spinWheel(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
